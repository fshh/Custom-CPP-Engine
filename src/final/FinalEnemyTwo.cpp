...
FinalEnemyTwo::FinalEnemyTwo(float x1, float y1, float size, std::weak_ptr<GameObject> player, int enemyTwoTag, int health, float hurtCooldown,
	...
	GameObject(x1, y1, size, size, enemyTwoTag)
{
	...
	addGenericComponent(std::make_shared<FinalEnemyTwoGun>(*this, Tags::tagOf("Enemy_Bullet"), bulletSprite, pistolSound));
