...
public:
  ...
  PatrolState(float speed, float x0, float y0, float x1, float y1, std::shared_ptr<AnimatorComponent> animator);
...
public:
  ...
  ChaseState(float speed, std::weak_ptr<GameObject> which, std::shared_ptr<AnimatorComponent> animator);
...
public:
  ...
  MoveState(float speed, float x, float y, std::shared_ptr<AnimatorComponent> animator);
